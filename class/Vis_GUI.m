classdef Vis_GUI
    ...
    methods
        ...
        function unit_conversion(obj)
            % create GUI class for input
            
            f= figure( ...
                'Tag', 'figure1', ...
                'Units', 'pixels', ...
                'Position', [500 507 260 240], ...
                'Name', 'Unit Convertor', ...
                'MenuBar', 'none', ...
                'NumberTitle', 'off', ...
            ...
            % static texts
            ypos = 180;
            textstring = {'Length','Divergence','Energy','Time','Charge'};                        
            popuptag = {'pop_length','pop_divergence','pop_energy','pop_time','pop_charge'};
